...
- Risk-based task routing (Alpha/Beta/Gamma/Operational)
...
- The activation layer (that is BizBot)
- The interface layer (that is AVA/AIVA)
- A replacement for canon

## Canonical Term

Use "Execution Engine" not "runtime."

This is the governed mechanism that routes and carries out work within the orchestration system.
