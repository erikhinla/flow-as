...
# Load task envelope schema
try:
    with open('schemas/task_envelope.schema.json', 'r') as f:
        TASK_ENVELOPE_SCHEMA = json.load(f)
except FileNotFoundError:
    logger.warning("Could not load task_envelope.schema.json")
